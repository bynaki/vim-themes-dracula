...
let g:dracula#palette.bglighter = ['#424450', 8]
let g:dracula#palette.bglight   = ['#343746', 9]
let g:dracula#palette.bg        = ['#282A36', 0]
let g:dracula#palette.bgdark    = ['#21222C', 10]
let g:dracula#palette.bgdarker  = ['#191A21', 11]

let g:dracula#palette.comment   = ['#6272A4', 12]
let g:dracula#palette.selection = ['#44475A', 13]
let g:dracula#palette.subtle    = ['#424450', 14]

let g:dracula#palette.cyan      = ['#8BE9FD', 6]
let g:dracula#palette.green     = ['#50FA7B', 2]
let g:dracula#palette.orange    = ['#FFB86C', 15]
let g:dracula#palette.pink      = ['#FF79C6', 5]
let g:dracula#palette.purple    = ['#BD93F9', 5]
